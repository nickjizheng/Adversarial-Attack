...
def multi_main(shared_frames, true_label):
    ...
    question = "In a paragraph: As your smart home security assistant, could you please analyze the images from the video footage, identify the baby's actions, and determine if the baby is in any dangerous situations or engaging in potentially hazardous activities that may require assistance?"
...
if __name__ == "__main__":
    shared_frames, true_label = uni_main(num_videos=1, specific_class=3)  # Run unimodal main function and share frames
